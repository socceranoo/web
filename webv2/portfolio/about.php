	...
	<body class='portfolio' id='pfbody'>
		...
		<div id="wrapper">			
			<div id="content">
				...
				<!--HALFCONTENTS -->	
				<div class="halfcontent imgholder" id="graph2"><img src="images/graph2.png"/></div>
				<div class="halfcontent"><?require("lorem.php");?></div>
			
				<div class="pagediv"><p>"Just because we’re growing up, it doesn’t mean we’ve had enough"</p></div>
			
				<!--HALFCONTENTS -->	
				<div class="halfcontent imgholder" id="bike"><img src="images/fifa13-2.png"/></div>
				<div class="halfcontent" id="facts">
				...
				<!--HALFCONTENTS -->	
				<div class="halfcontent"><?require("lorem.php");?></div>
				<div class="halfcontent imgholder" id="graph1"><img src="images/graph.png"/></div>
				<!--
				<div class="halfcontent" id="uiskills">
					<div class="vline"></div>
					<div class="hline"></div>
				</div>
				-->
				...
				<!--HALFCONTENTS -->	
				<div class="halfcontent"><?require("lorem.php");?></div>
				<div class="halfcontent imgholder" id="graph3"><img src="images/graph3.png"/></div>
