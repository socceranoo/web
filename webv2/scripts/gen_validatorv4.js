...
function Validator(frmname)
{
  this.formobj=document.forms[frmname];
   ...
   if(this.formobj.onreset)
   {
    this.formobj.old_onreset = this.formobj.onreset;
    this.formobj.onreset=null;
   }
   else
   {
    this.formobj.old_onreset = null;
   }
   this.formobj._sfm_form_name=frmname;
   this.formobj.onreset=form_submit_handler;
