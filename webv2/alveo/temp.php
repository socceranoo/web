		...
		<div class="main-container">
			...
			<div class="maincontent">
				<div class="pagecontent">
					...
					<img src="energyA4.png" alt="" />
					<div id=vision class="vision test center no-border rounded">
						<div id=vision-text class="vision-text">
							<p>People: Be a great place to work where people are inspired to be the best they can be.</p>
							<p>Portfolio: Bring to the world a portfolio of quality batteries that satisfy world's energy needs.</p>
